...
namespace AgroFuturo.Controllers
{
    public class EquipamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EquipamentoId,Nome")] Equipamento equipamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipamentoId,Nome")] Equipamento equipamento)
        {
